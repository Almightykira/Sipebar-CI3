...
class Report_receiving extends CI_Controller
{
    ...
    public function cetak()
    {
        ...
        $pdf->Cell(37, 6, 'No Receiving', 1, 0, 'C');
        $pdf->Cell(34, 6, 'Supplier', 1, 0, 'C');
        $pdf->Cell(34, 6, 'remarks', 1, 1, 'C');
        ...
        foreach ($gangguan as $data) {
            ...
            $pdf->Cell(37, 6, $data->no_receiving, 1, 0);
            $pdf->Cell(34, 6, $data->supplier, 1, 0);
            $pdf->Cell(34, 6, $data->remarks, 1, 1);
        }
        $pdf->Output();
    }
}
