    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if ($this->session->userdata('level') == 'Operator') { ?>
          ...
          <li class="nav-item">
            <a href="<?= base_url('index.php/operator/kategori') ?>" class="nav-link">
              <p class="text">Kategori</p>  
            </a>
          </li>
          <li class="nav-item">
            <a href="<?= base_url('index.php/operator/uom') ?>" class="nav-link">
              <p class="text">Satuan</p>  
            </a>
          </li>
          <li class="nav-item">
            <a href="<?= base_url('index.php/operator/brand') ?>" class="nav-link">
              <p class="text">Data Obat</p>  
            </a>
          </li>
          ...
          <li <?= $this->uri->segment(2) == 'master_data_barang' || $this->uri->segment(2) == '' ? 'class="active"' : '' ?>>
            <a href="<?= base_url('index.php/operator/master_data_barang') ?>">
              <i class="fa fa-shopping-bag"></i> <span>Master Data Barang</span>
            </a>
          </li>
        ...
        <?php if (($this->session->userdata('level') == 'Operator') or ($this->session->userdata('level') == 'Manager')) { ?>
          <li class="treeview <?= $this->uri->segment(2) == 'report_stock' ||
            ...
            <ul class="treeview-menu">
              <li <?= $this->uri->segment(2) == 'report_stock' || $this->uri->segment(2) == '' ? 'class="active"' : '' ?>><a href="<?= base_url('index.php/report/report_stock') ?>"><i class="fa fa-circle-o"></i> Laporan Stok</a></li>
